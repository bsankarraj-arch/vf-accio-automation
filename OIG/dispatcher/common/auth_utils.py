...
prod_oig_url = "https://verifiedfirst.bgsecured.com/c/s2/worklist?report_name_selector=s%3AOIG%20Automation%20Report"
# dev_url's
base_url = "https://vfbeta.bgsecured.com/"
dev_login_url = "https://vfbeta.bgsecured.com/sysops/sysop_home9.html"
dev_oig_url = "https://vfbeta.bgsecured.com/c/s2/worklist?dynamic_report_name=s:OIG%20Automation%20Report"


if prod_flag:
    login_url = prod_login_url
    oig_url = prod_oig_url
else:
...
def get_worklist_urls(page):
    """Navigates to the OIG worklist and extracts all task URLs."""
    target_url = oig_url
    # base_url = "https://vfbeta.bgsecured.com"
    ...
    try:
        ...
        logging.info(f"Found {row_count} total rows in table. Filtering for OIG tasks...")
        ...
        logging.info(f"Successfully extracted {len(urls)} OIG URLs.")
        return urls
